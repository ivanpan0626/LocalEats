    ...
    <>
      ...
      {isMounted && (
        <div
          ...
          } z-50 sm:w-[300px]`} // Increased width for the cart
        >
          <div className="flex flex-col h-full">
            ...
            <h2 className="font-bold text-xl text-center py-2">Your Cart</h2> {/* Smaller title size */}
              ...
              <div className="flex-1 overflow-y-auto px-4 custom-scroll">
                <ul>
                  {cart.items.map((item) => (
                    <li
                      key={item.food.id}
                      className="flex justify-between items-center mb-3 border-b pb-2" // Reduced bottom margin
                    >
            ...
            <div className="flex justify-between items-center mt-4 px-4 py-2 border-t">
              <span className="font-semibold text-lg">Total:</span> {/* Smaller text size */}
            ...
            <div className="flex justify-center mt-4 px-4">
              <Link
                to="/checkout"
                onClick={toggleCart}
                className="px-6 py-2 bg-red-600 text-white rounded-full w-full sm:w-auto" // Reduced padding
              >
                Checkout
              </Link>
            </div>
